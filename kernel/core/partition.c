...
//TODO set sched func pointer
//edf
#ifdef POK_NEEDS_SCHED_EDF
   case POK_SCHED_EDF:
      printf("sched edf is set\n");
...
pok_ret_t pok_partition_init()
{
   ...
   const uint32_t program_loadaddr[POK_CONFIG_NB_PARTITIONS] = POK_CONFIG_PROGRAM_LOADADDR;
#endif
