CFLAGS	=	$(CONFIG_CFLAGS) -nostdinc -iwithprefix include -fno-builtin -DPOK_ARCH_X86 $(KIND_CFLAGS) $(GENERIC_FLAGS) -g -O -Wuninitialized -fno-stack-protector -ffreestanding -nostdlib -fstack-check
